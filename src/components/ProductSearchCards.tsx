...
export default function ProductSearchCards() {
  ...
  return (
  <div className="max-w-[1100px] md:max-w-[900px] lg:max-w-[1400px] mx-auto px-2 md:px-4 font-geist">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 md:gap-16 lg:gap-20 justify-items-center lg:justify-items-stretch">
        {cards.map((card) => (
          <div
            key={card.id}
            className="relative bg-white rounded-2xl p-5 md:p-7 lg:p-7 transition-shadow w-full max-w-[400px] md:max-w-[520px] md:min-w-[360px] lg:max-w-none lg:min-w-[380px] mx-auto"
          >
            {/* Numbered Badge */}
            ...
            <div className=" mb-4 flex items-center justify-center">
              <Image
                ...
                width={600}
                height={450}
                className="w-full h-auto max-w-[360px] md:max-w-[420px] lg:max-w-none lg:min-w-[340px]"
              />
            </div>
            ...
            {/* Description */}
            <p className="text-[16px] text-[#909293] leading-[24px] font-normal text-center">
              {card.description}
            </p>
          </div>
        ))}
