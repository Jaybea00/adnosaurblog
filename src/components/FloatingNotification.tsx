...
export default function FloatingNotification() {
  ...
  return (
    ...
    >
      <div className="bg-[#dededc] rounded-2xl shadow-lg px-3 md:px-3 py-2 md:py-2 flex items-center justify-center gap-2 md:gap-3 max-w-[280px] md:max-w-sm border border-gray-200">
        {/* Icon */}
        <div className="flex-shrink-0 w-8 md:w-9.5 h-8 md:h-9.5 bg-white rounded-[0.7rem] flex items-center justify-center shadow-sm ">
          <Image
        ...
        <div className="flex-1 min-w-0 font-inter">
          <div className="flex items-center justify-between gap-2 mb-1">
            <h4 className="font-bold text-black text-xs md:text-[14px]">
          ...
          <p className="text-xs md:text-[13px] text-black leading-snug">
