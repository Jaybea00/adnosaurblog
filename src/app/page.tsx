...
export default function Home() {
  return (
    <div className="min-h-screen overflow-x-hidden">
      <section className="relative lg:text-white overflow-visible flex items-center justify-center lg:min-h-[90vh] pt-20 min-[400px]:pt-[6rem] sm:pt-20 md:pt-[4rem] lg:pt-12 pb-0 lg:pb-10 [@media(min-width:1400px)_and_(max-width:4500px)]:min-h-[5vh]">
